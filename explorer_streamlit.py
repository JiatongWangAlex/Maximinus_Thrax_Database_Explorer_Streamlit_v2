...
with st.expander("Click to View Site Instructions / Welcome Text", expanded=False, key="welcome_instructions_expander"):
    st.markdown("""
## How to Use | DEVELOPMENT NOTE: THIS INSTRUCTION MANUAL REFLECTS AN EARLIER VERSION OF THE INTERFACE; I AM GOING TO REWRITE THE MANUAL.
## DEVELOPMENT NOTE: THIS INSTRUCTION MANUAL REFLECTS AN EARLIER VERSION OF THE INTERFACE; I AM GOING TO REWRITE THE MANUAL.
## FOR NOW, JUST REMEMBER, IF YOU CLICK ON A LINK TO AN ITINER-E ROAD SEGMENT, YOU MAY ENCOUNTER THE ITINER-E WELCOME SCREEN FIRST INSTEAD BEING SHOWN THE ROAD SEGMENT
## CLICK EXPLORE ROMAN ROADS IF YOU SEE THAT WELCOME SCREEN; THIS WILL TAKE YOU TO THE ROAD SEGMENT
