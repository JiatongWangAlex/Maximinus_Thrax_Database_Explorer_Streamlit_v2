...
st.markdown(
    ...
    <div style="text-align: center; color: #475569; font-size: 14px; margin-bottom: 15px; padding: 0 20px; line-height: 1.5;">
        <strong>Open Access & Research Dataset</strong><br>
        This dataset combines data generated by my original research with data from open-access digital resources. 
        The complete compiled database is free to download, use, and redistribute 
        under a <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" style="color: #1a53ff; text-decoration: none; font-weight: 600;">Creative Commons Attribution 4.0 International License (CC BY 4.0)</a>.
    </div>
    """, 
    unsafe_allow_html=True
)
