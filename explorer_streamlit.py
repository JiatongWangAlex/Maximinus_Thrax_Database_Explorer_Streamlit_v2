...
with st.expander("Advanced Search", expanded=False):
    ...
    with col2:
        ...
        f_person_operator = st.radio("Match included people using:", options=["OR (Any of them)", "AND (All of them together)"], horizontal=True, index=0, key="rad_person_op", on_change=reset_map_and_search_flags)
