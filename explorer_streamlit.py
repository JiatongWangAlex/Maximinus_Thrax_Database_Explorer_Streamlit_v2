...
def run_standard_search(user_input):
    ...
    try:
        ...
        Sec0_Metadata AS (
            ...
            UNION ALL SELECT 0 AS sg, 0 AS seq_id, 2 AS inner_lo, '**Inscription Text (Formatted):**' || char(10) || char(10) || '> ' || replace(COALESCE(inscription_text_formatted, 'N/A'), char(10), char(10) || '> ') || char(10) || char(10) AS tl FROM Metadata_Joined
