...
with st.expander("Advanced Search", expanded=False):
    ...
    with col2:
        ...
        f_person_operator = st.radio("Include:", options=["OR (Inscriptions mentioning any of these people)", "AND (Inscriptions mentioning all of these people)"], horizontal=True, index=0, key="rad_person_op", on_change=reset_map_and_search_flags)
        ...
        raw_person_exc_op = st.radio("Exclude:", options=["OR (Inscriptions mentioning any of these people)", "AND (Inscriptions mentioning all of these people)"], horizontal=True, index=0, key="rad_person_exc_op", on_change=reset_map_and_search_flags)
